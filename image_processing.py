...
class Blob:
    def __init__(self, area, centroid, holeFactor, xmin, ymin, width, height):
        self.area = area
    ...
    for i, idx in enumerate(sorted_indices):
        ...
        if area >= min_area:
            blobs.append(Blob(
                ...
                holeFactor=cv.contourArea(cv.convexHull(contours[idx])), # feature for separating cubes and targets
